const siteContent = {
  ...
  usefulLinks: [
    ...
    {
      title: "WCHCS Nitrogen Calculator — Interactive",
      summary: "Browser-based version of the WCHCS Nitrogen Calculator (8/21/2025). Enter the design flow, water supply, soil type, and proposed lot size without downloading Excel.",
      url: "#nitrogen-calculator",
      linkLabel: "Open Calculator",
      tags: ["Calculator", "Nitrogen", "WCHCS"]
    },
    {
...
function setupNitrogenCalculator() {
  ...
  const anchor = document.querySelector("#usefulLinks");
  if (!anchor) return;
  ...
  section.innerHTML = `
    <div class="nitrogen-calculator-shell">
      ...
      <div class="nitrogen-footer">
        ...
        <em>Nitrogen Calculator 8.21.2025.xlsx</em>.
